...
class PretrainConfig(Config):
    def __init__(self, udf_config=None):
        ...
        config_json = {
            ...
            "predict_config": {
                ...
                "output_schema": "image_feature:float:131072", 
                "export_dir_base": _APP_FLAGS.output_dir
            },
            "export_config": {
                "export_dir_base": _APP_FLAGS.output_dir
            },
        }
        config_json["export_dir_base"] = FLAGS.output_dir
